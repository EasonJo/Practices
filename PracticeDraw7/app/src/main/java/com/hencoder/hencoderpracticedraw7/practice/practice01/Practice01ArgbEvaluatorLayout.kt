...
class Practice01ArgbEvaluatorLayout : RelativeLayout {
    private lateinit var view: Practice01ArgbEvaluatorView
    ...
    override fun onAttachedToWindow() {
        ...
        animateBt.setOnClickListener {
            ...
            //SDK > 23 的时,可以直接使用以下 API
            if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
                animator = ObjectAnimator.ofArgb(view, "color", -0x10000, -0xff0100)
            } else {
                animator = ObjectAnimator.ofInt(view, "color", -0x10000, -0xff0100)
                animator.setEvaluator(ArgbEvaluator())
            }
